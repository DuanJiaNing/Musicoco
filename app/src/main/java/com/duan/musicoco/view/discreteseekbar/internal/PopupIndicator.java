...
package com.duan.musicoco.view.discreteseekbar.internal;
...
public class PopupIndicator {
    ...
    //Outside clickListener for the DiscreteSeekBar to getBitmapForVisualizer MarkerDrawable animation events.
